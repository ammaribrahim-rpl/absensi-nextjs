...
export const metadata: Metadata = { title: 'Kelola Karyawan (Admin)' };
export const dynamic = 'force-dynamic';

export default async function AdminKaryawanPage({ searchParams }: { searchParams: Promise<Record<string,string>> }) {
